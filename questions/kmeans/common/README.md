...
1. _k initial "centroids" (in this case k=3) are randomly generated within the data domain (shown in color)._
   ![](https://upload.wikimedia.org/wikipedia/commons/5/5e/K_Means_Example_Step_1.svg)
2. _k clusters are created by associating every observation with the nearest centroid._
