...
def datasets() -> dict[str, list[Point]]:
    """Read datasets.json fresh — sync regenerates it in the same process, just before these run."""
    return {name: [(x, y) for x, y in points] for name, points in json.loads((QUESTION / "datasets.json").read_text()).items()}
...
if __name__ == "__main__":
    write_solutions(HERE / "solutions.py")
    write_answers(QUESTION / "answers.md")
    print("wrote solutions.py, answers.md")
