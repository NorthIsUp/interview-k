...
| 🖼️                                                                                  | 🔤                                                                                                       |
| ----------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| ![](https://upload.wikimedia.org/wikipedia/commons/5/5e/K_Means_Example_Step_1.svg) | _k_ initial "means" (in this case _k_=3) are randomly generated within the data domain (shown in color). |
| ![](https://upload.wikimedia.org/wikipedia/commons/a/a5/K_Means_Example_Step_2.svg) | _k_ clusters are created by associating every observation with the nearest mean.                         |
